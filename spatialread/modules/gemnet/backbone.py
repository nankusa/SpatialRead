...
from spatialread.utils.typed import TypedModuleList
from torch_geometric.data.data import BaseData
from torch_scatter import segment_coo

from spatialread.utils.scaling.compat import load_scales_compat
from spatialread.utils.goc_graph import graphs_from_batch
...
from spatialread.utils.gemnetutils import (
    get_angle,
    get_edge_id,
    get_inner_idx,
...
class GemNetOCBackbone(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("DEBUG load scale", scale_file)
