...
def _generate_graph(
    ...
    *,
    ...
    if pbc:
        ...
        edge_index, edge_dist, distance_vec, [cell_offsets, cell_offset_distances] = filter_edge(edge_index, edge_dist, distance_vec, 'p2pv', data.atomic_numbers==VNODE_Z, cutoff, max_neighbors, other_content=[cell_offsets, cell_offset_distances])
